package com.yomigatz.peeling.colorful;
...
import com.yomigatz.colorful.Colorful;

import java.util.ArrayList;
import java.util.List;

import com.yomigatz.colorful.setter.ViewGroupSetter;
import com.yomigatz.peeling.R;
...
public class ColorFulActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_color_ful);
		...
		findViewById(R.id.second_btn).setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ColorFulActivity.this, RecyclerActivity.class);
