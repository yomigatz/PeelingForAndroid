...
public class SkinCompatProgressBarHelper extends SkinCompatHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = mView.getContext().obtainStyledAttributes(attrs, skin.support.R.styleable.SkinCompatProgressBar, defStyleAttr, 0);

        mIndeterminateDrawableResId = a.getResourceId(skin.support.R.styleable.SkinCompatProgressBar_android_indeterminateDrawable, INVALID_ID);
        mProgressDrawableResId = a.getResourceId(skin.support.R.styleable.SkinCompatProgressBar_android_progressDrawable, INVALID_ID);
