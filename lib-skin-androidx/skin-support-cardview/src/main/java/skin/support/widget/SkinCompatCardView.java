...
public class SkinCompatCardView extends CardView implements SkinCompatSupportable {
    ...
    public SkinCompatCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, androidx.cardview.R.styleable.CardView, defStyleAttr,
                androidx.cardview.R.style.CardView);
        if (a.hasValue(androidx.cardview.R.styleable.CardView_cardBackgroundColor)) {
            mBackgroundColorResId = a.getResourceId(androidx.cardview.R.styleable.CardView_cardBackgroundColor, INVALID_ID);
        } else {
    ...
    private void applyBackgroundColorResource() {
        ...
        if (mBackgroundColorResId != INVALID_ID) {
            ...
            backgroundColor = ColorStateList.valueOf(hsv[2] > 0.5f
                    ? getResources().getColor(androidx.cardview.R.color.cardview_light_background)
